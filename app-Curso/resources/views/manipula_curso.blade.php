            ...
            <div class="col-10 ">
              <div class="invoice-card card-style mb-30">
                <div class="card-style mb-30 ">
                  <h6 class="mb-25 fs-4">Digite o nome da Curso de curso</h6>
                    ...
                    <div class="container m-5">
                      <form method="get" action="/editar-Curso">
                        <div class="row">
                          ...
                          <div class="col-6">
                            <input type="text" id="Curso" name="Curso" class="form-control" placeholder="Digite a Curso" aria-label="First name">
                          </div>
